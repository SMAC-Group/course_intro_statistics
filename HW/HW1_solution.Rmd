...
Based on this graph, it clearly appears that t-test doesn't may not be suitable solution and we select instead a Wilcoxon test. Assuming that an average oxygen saturation below 95 can be considered as "low", we perform the following analysis:
